...
class Config:
    """PRODUCTION Configuration for VyuhMitra - LIVE DATA ONLY with extensive logging"""
    ...
    DEFAULT_FROM_STATION = "NDLS"  # New Delhi (34 active trains confirmed!)
    ...
    # Rate limiting - OPTIMIZED for live data
    RAILRADAR_MIN_REQUEST_INTERVAL = 15  # Faster for real-time updates
    
    # Demo data control - COMPLETELY DISABLED for LIVE DATA ONLY
    ENABLE_DEMO = False  # NEVER use demo data
